...
namespace Nabludai\GeoipBundle\Manager;
...
class GeoManager {
    ...
    public function __construct(Container $container) {
        ...
        $db_file = $this->kernel->locateResource($container->getParameter('nabludai_geoip.database_path'));
        $type = $container->getParameter('nabludai_geoip.mode');
